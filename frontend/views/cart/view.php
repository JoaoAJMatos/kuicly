...
<div class="container py-5">
    ...
    <div class="row">
        <div class="col-md-12">
            <h5 class="text-center">Nome: <?= $model->profile->name ?></h5>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h5 class="text-center">Di: <?= $model->profile->address ?></h5>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h5 class="text-center">Telefone: <?= $model->profile->phone_number ?></h5>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
